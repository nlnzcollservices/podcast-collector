...
def export_data_to_csv(csv_file_path="complete_podcasts_data.csv"):
    headers = [
        ...
        'Publish Link To Record', 'Automated Flag', 'Last Issue', 'Template Name', 'Episode ID', 'Episode Title', 'Bib Title',
        'Bib Numbering', 'Subtitle', 'Description', 'Date', 'Episode Link', 'Tags', 'Date Harvested', 'Harvest Link',
        ...
        'F710 Second', 'F710 Third', 'Tick', 'Cataloguer', 'MIS MMS', 'SIP', 'MIS POL', 'Holdings', 'Item', 'Receive', 'IE Num',
            ...
            for ep in Episode.select().where(Episode.podcast == pod):
                ...
                for fl in files:
                    row = {
                        ...
                        'Episode ID': ep.id, 'Episode Title': ep.episode_title, 'Bib Title': ep.bib_title, 'Bib Numbering':ep.bib_numbering,'Subtitle': ep.subtitle,
                        ...
                        'F600 First': ep.f600_first, 'F600 Second': ep.f600_second,
                        ...
                        'Tick': ep.tick, 'Cataloguer': ep.cataloguer, 'MIS MMS': ep.mis_mms, 'SIP': ep.sip, 'MIS POL': ep.mis_pol,
